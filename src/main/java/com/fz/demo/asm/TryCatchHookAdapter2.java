...
public class TryCatchHookAdapter2 extends AdviceAdapter {
    ...
    protected TryCatchHookAdapter2(MethodVisitor methodVisitor, String className, int access, String name,
